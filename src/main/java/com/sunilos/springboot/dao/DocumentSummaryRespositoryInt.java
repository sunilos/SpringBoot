...
/**
 * 
 * Repository provides CRUD for document information
 * 
...
@Repository
public interface DocumentSummaryRespositoryInt extends JpaRepository<DocumentSummary, Long>, JpaSpecificationExecutor<DocumentSummary> {
